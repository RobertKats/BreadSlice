...
class MyForum extends StatefulWidget {
  ...
  State<StatefulWidget> createState() =>
      MyForumState(this.itemList, this.totalData);
}
              ...
              new FlatButton(
                  onPressed: () {
                    ...
                    SaveingData.saveData(
                        new IOUData(totalData: totalData, itemData: itemList),
                        saveFile.text);
                    saveFile.text = "";
                    Navigator.of(context).pop();
                  },
                  child: Text("Save")),
              new Padding(padding: EdgeInsets.fromLTRB(50, 0, 50, 0)),
              new FlatButton(
                child: Text('Cancel'),
                onPressed: () {
                  Navigator.of(context).pop();
      ...
      itemBuilder: (context, i) {
        ...
        return Column(
          children: <Widget>[
            ...
            UserField(
              user: item.subList[i].user,
              price: item.subList[i].price,
            )
            //(subList[item])[i],
            // Dismissible(
